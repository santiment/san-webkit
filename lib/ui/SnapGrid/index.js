...
import { autoScroll, getScrollingParent } from './../../ui/dnd/scroll.js';
import { Field } from './types.js';
import { Draggable } from './event.js';
import { normalizeGrid, resolveDraggedCollisions, Dropzone, sortLayout, updateGridContainerHeight, setGridContainerHeight, } from './layout.js';
import { calcY, getTranslate, translateLayoutItem } from './style.js';
...
export function SnapGrid(layout, settings, handlers) {
    const { cols, rowSize, gridWidth, maxCols = cols, minCols = 1, maxRows, minRows = 1, margin = [12, 12], readonly = false, } = settings;
