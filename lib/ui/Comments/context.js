...
export const setScrollToCommentContext = (scrollToComment) => setContext(SCROLL_TO_COMMENT_CONTEXT, scrollToComment);
...
export const setGetRepliedToCommentContext = (getRepliedToComment) => setContext(GET_REPLIED_TO_COMMENT_CONTEXT, getRepliedToComment);
