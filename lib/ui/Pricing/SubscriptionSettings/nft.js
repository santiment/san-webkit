...
const mutateObtainSanrNftSubscription = () => mutate(`mutation { obtainSanrNftSubscription {
  status
}}`);
export var NftErrors;
(function (NftErrors) {
    NftErrors["NoAddress"] = "The user does not have any blockchain addresses connected";
    NftErrors["ActiveSubscription"] = "The user already has an active Sanbase subscription";
    NftErrors["NoNft"] = "The user is not eligible for the SanR NFT subscription. None of user addresses has a valid SanR NFT token.";
})(NftErrors || (NftErrors = {}));
...
export async function startCheckNftAccessFlow(customer$) {
