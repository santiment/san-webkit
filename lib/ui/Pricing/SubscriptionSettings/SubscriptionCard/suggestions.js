import { BUSINESS_PLANS, Billing, Plan, checkIsBusinessPlan, checkIsIndividualPlan, } from './../../../../utils/plans.js';
...
export function getBusinessSuggestions(userPlan) {
    ...
    const planIndex = Array.from(BUSINESS_PLANS).indexOf(userPlan.name);
    if (planIndex === -1)
        return allBusinessSuggestions;
