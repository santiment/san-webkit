...
export function getSuggestions(userPlan, annualDiscount) {
  ...
  if (annualDiscount === null || annualDiscount === void 0 ? void 0 : annualDiscount.discount) {
    ...
    if ((userPlan === null || userPlan === void 0 ? void 0 : userPlan.name) === Plan.PRO) {
      suggestions.push(
        Object.assign(Object.assign({}, suggestion), { [Plan.PRO_PLUS]: PRO_PLUS_SUGGESTION }),
      )
    }
    return suggestions
  }
  ...
  const suggestion = {
    billing:
      (userPlan === null || userPlan === void 0 ? void 0 : userPlan.interval) || Billing.MONTH,
  }
  if ((userPlan === null || userPlan === void 0 ? void 0 : userPlan.name) !== Plan.PRO) {
    suggestions.push(Object.assign(Object.assign({}, suggestion), { [Plan.PRO]: PRO_SUGGESTION }))
  }
  suggestions.push(
    Object.assign(Object.assign({}, suggestion), {
      ...
      isUpgrade: (userPlan === null || userPlan === void 0 ? void 0 : userPlan.name) === Plan.PRO,
    }),
  )
  return suggestions
}
