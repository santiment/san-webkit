...
export const showBillingHistoryDialog = (props) => dialogs.show(BillingHistoryDialog, props);
</script>
...
<Dialog {...$$props} title="Billing history">
  <div class="dialog-body">
    <Table {columns} items={history} class="border table-AgcH8R" />
  </div>
</Dialog>
...
<style>
  ...
  :global(.table-AgcH8R) :global(thead) {
    position: sticky;
    top: -21px;
  }
</style>
