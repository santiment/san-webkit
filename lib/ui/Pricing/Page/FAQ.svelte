...
const QA = [{
  ...
  answer: 'Yes! You can pay in ETH, BTC or any established Ethereum-based stablecoin. There are other options too, involving our SAN token. You can find more information here: ' + link('pay with crypto', 'https://academy.santiment.net/products-and-plans/how-to-pay-with-crypto/')
}, {
...
<section id="faq">
  ...
  {#each QA as { question, answer } (question)}
    ...
    >
      ...
      <Svg id="arrow-down" w="14" h="8" class={'arrow-2qwpvz'} />
    </div>
