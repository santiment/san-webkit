...
<Dialog {...$$props} noTitle bind:closeDialog class="dialog-003gDR">
  ...
  {:else if hasDiscount}
    ...
    />
  {:else}
    <FlamePumpkin class="flame-pumpkin-2JTWJA" />
  {/if}
  <div class="column hv-center txt-center">
    ...
    {#if hasDiscount || code}
      <DiscountCode class="copy-7o6DnM" discount={code || 'SANHALLOWEEN2022'} />
      <a
