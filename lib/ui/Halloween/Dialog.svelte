...
<Dialog {...$$props} noTitle bind:closeDialog class="dialog-2eZClf">
  ...
  {:else if hasDiscount}
    ...
    />
  {:else}
    <FlamePumpkin class="flame-pumpkin-33V5vo" />
  {/if}
  <div class="column hv-center txt-center">
    ...
    {#if hasDiscount || code}
      <DiscountCode class="copy-1TJtBw" discount={code || 'SANHALLOWEEN2022'} />
      <a
