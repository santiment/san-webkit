...
<Dialog {...$$props} noTitle bind:closeDialog class="dialog-X4zUWQ">
  ...
  {:else if hasDiscount}
    ...
    />
  {:else}
    <FlamePumpkin class="flame-pumpkin-ZlWnrF" />
  {/if}
  <div class="column hv-center txt-center">
    ...
    {#if hasDiscount || code}
      <DiscountCode class="copy-HpZmc3" discount={code || 'SANHALLOWEEN2022'} />
      <a
