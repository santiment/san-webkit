...
<Dialog {...$$props} noTitle bind:closeDialog class="dialog-waBwxG">
  ...
  {:else if hasDiscount}
    ...
    />
  {:else}
    <FlamePumpkin class="flame-pumpkin-nuagrj" />
  {/if}
  <div class="column hv-center txt-center">
    ...
    {#if hasDiscount || code}
      <DiscountCode class="copy-q62IPd" discount={code || 'SANHALLOWEEN2022'} />
      <a
