...
<Dialog {...$$props} noTitle bind:closeDialog class="dialog-JlMfG8">
  ...
  {:else if hasDiscount}
    ...
    />
  {:else}
    <FlamePumpkin class="flame-pumpkin-PWwXMS" />
  {/if}
  <div class="column hv-center txt-center">
    ...
    {#if hasDiscount || code}
      <DiscountCode class="copy-knEoCw" discount={code || 'SANHALLOWEEN2022'} />
      <a
