...
<Dialog {...$$props} noTitle bind:closeDialog class="dialog-ylYBtX">
  ...
  {:else if hasDiscount}
    ...
    />
  {:else}
    <FlamePumpkin class="flame-pumpkin-sPPlCp" />
  {/if}
  <div class="column hv-center txt-center">
    ...
    {#if hasDiscount || code}
      <DiscountCode class="copy-OjAaSz" discount={code || 'SANHALLOWEEN2022'} />
      <a
