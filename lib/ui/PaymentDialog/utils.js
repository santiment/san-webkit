...
function submitPayment(plan, discount, cardTokenId, hasSanTokensDiscount = false) {
...
export function buyPlan(plan, stripe, card, form, savedCard, hasSanTokensDiscount = false) {
