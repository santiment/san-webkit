...
<style >:global(.medium-editor-toolbar),
...
:global(.medium-editor-toolbar-actions) > :global(li:nth-child(3)::before), :global(.medium-editor-toolbar-actions) > :global(li:nth-child(5)::before) {
  content: "";
  display: block;
  margin: 0 8px;
  width: 1px;
