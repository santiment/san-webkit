...
export function newHistory(emitter) {
    let history = [];
    let cursor = -1;
    const emit = (action, cmd) => emitter === null || emitter === void 0 ? void 0 : emitter({ action, name: cmd.name });
    return {
        get() {
            return history;
        },
...
export const scroll = (target) => target === null || target === void 0 ? void 0 : target.scrollIntoView();
