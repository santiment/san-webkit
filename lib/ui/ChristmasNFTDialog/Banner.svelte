...
<section class="row justify">
  <div class="info column">
    <div class="logo row v-center">
      <Svg illus id="santiment" w="86" h="16" class="santiment-cvNUD2" />
    ...
    {#if $IsMobile}
      <div class="tip row">
        <Svg id="light" w="16" h="22" class="light-B3TdJV mrg-m mrg--r" />
...
:global(body:not(.desktop)) :global(.light-B3TdJV) {
  fill: var(--purple);
}</style>
