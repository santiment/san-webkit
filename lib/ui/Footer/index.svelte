    ...
    <div class="body-2 row top justify c-waterloo">
      ...
      <div class="forms">
        <div class="digest">
          ...
          <DigestForm
            class="mrg-xl mrg--b form-42Fn4s {$IsMobile ? '' : 'body-3'}"
            label="Subscribe"
          />
        </div>
      </div>
...
:global(body:not(.desktop)) :global(.form-42Fn4s) {
  width: auto;
}
...
:global(.phone-xs) :global(.form-42Fn4s),
:global(.phone) :global(.form-42Fn4s) {
  margin-bottom: 40px;
}
