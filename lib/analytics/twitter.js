...
export function trackTwitterPurchaseEvent() {
  var _a
  ;(_a = window.twttr) === null || _a === void 0
    ? void 0
    : _a.conversion.trackPid('o8scf', { tw_sale_amount: 0, tw_order_quantity: 0 })
}
export function trackTwitterSignUpEvent() {
  var _a
  ;(_a = window.twttr) === null || _a === void 0
    ? void 0
    : _a.conversion.trackPid('o8scy', { tw_sale_amount: 0, tw_order_quantity: 0 })
}
