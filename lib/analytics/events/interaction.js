...
export const trackFormOpen = (type) => track('share_form_open', { type, source_url: window.location.href });
export const trackFormSubmit = (shared_to) => track('share_form_submit', { shared_to });
export const trackShareLinkCopy = (url) => track('share_link_copy', { url, source_url: window.location.href });
