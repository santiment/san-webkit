...
export const trackPageView = ({ url = window.location.href, type, sourceType, sourceUrl, searchParams, sourceSearchParams, }) => track('page_view', {
    url,
    type,
...
export const trackLink = ({ type, url, source, external = false }) => track('link', {
    type,
    url,
    source,
    external,
