...
export function query(scheme, options, requestOptions) {
  const isWithCache =
    process.browser && (options === null || options === void 0 ? void 0 : options.cache) !== false
  if (isWithCache) {
    const cachedScheme = getCacheScheme(scheme, options)
    if (
      (options === null || options === void 0 ? void 0 : options.cachePolicy) !==
      CachePolicy.NewCache
    ) {
      ...
      Object.assign(
        {
          headers: HEADERS,
          body:
            (requestOptions === null || requestOptions === void 0 ? void 0 : requestOptions.body) ||
            JSON.stringify({
              query: scheme,
              variables:
                (options === null || options === void 0 ? void 0 : options.variables) || null,
              // operationName: null,
            }),
        },
        requestOptions,
  ...
  if (precacher)
    request = request.then(
      precacher(options === null || options === void 0 ? void 0 : options.variables),
    )
  if (isWithCache) {
