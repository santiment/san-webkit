...
const fetch = globalThis.fetch || process.env.SERVER_FETCH;
...
export function query(scheme, options, requestOptions) {
    ...
    const isWithCache = BROWSER && (options === null || options === void 0 ? void 0 : options.cache) !== false;
    if (isWithCache) {
    ...
    let request = fetch((!BROWSER && process.env.NODE_GQL_SERVER_URL) || process.env.GQL_SERVER_URL, Object.assign(Object.assign({ headers: HEADERS, body: (requestOptions === null || requestOptions === void 0 ? void 0 : requestOptions.body) ||
            JSON.stringify({
                query: scheme,
...
export function newSSRQuery(clb) {
    return (...args) => clb(...args.slice(0, -1), BROWSER
        ? undefined
        : {
