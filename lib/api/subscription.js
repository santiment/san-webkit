...
export const mutateUpdatePaymentCard = (cardToken) =>
  mutate(UPDATE_PAYMENT_CARD_MUTATION(cardToken))
// -------------------------------
...
export const mutateUpdateSubscription = (currentSubscriptionId, planId) =>
  mutate(UPDATE_SUBSCRIPTION_MUTATION(currentSubscriptionId, planId))
// ---------------------------
