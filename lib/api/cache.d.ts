export declare const Cache: {
  ...
  get$<T_3 extends SAN.API.QueryBase>(
    scheme: string,
    subscriber: SAN.API.Subscriber<T_3>,
...
export declare const getCacheScheme: (
  scheme: string,
  options: SAN.API.QueryOptions<any, any> | undefined,
) => string
declare type SchemeCacher<T extends SAN.API.QueryBase> = (data: T) => T
export declare const schemeCacheSetter: <T extends SAN.API.QueryBase>(
  scheme: string,
  options?: SAN.API.QueryOptions<T, any> | undefined,
) => SchemeCacher<T>
...
export declare function newSsrClientCacher<T extends SsrCacheCallback<Parameters<T>[0]>>(
  clb: T,
): SsrCacher<T>
