...
const isBtcSegwitAddress = addressChecker(/\b(bc(0([ac-hj-np-z02-9]{39}|[ac-hj-np-z02-9]{59})|1[ac-hj-np-z02-9]{8,87})|[13][a-km-zA-HJ-NP-Z1-9]{25,35})\b/); // GarageInc | 12.03.2021: https://github.com/bitcoin/bips/blob/master/bip-0173.mediawiki
