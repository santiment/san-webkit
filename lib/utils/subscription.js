...
export function getUserSubscriptionInfo(customerData, subscription) {
  ...
  const annualDiscountPercent =
    (annualDiscount === null || annualDiscount === void 0 ? void 0 : annualDiscount.isEligible) &&
    ((_a = annualDiscount.discount) === null || _a === void 0 ? void 0 : _a.percentOff)
  const discountExpireAt =
    (annualDiscount === null || annualDiscount === void 0 ? void 0 : annualDiscount.isEligible) &&
    ((_b = annualDiscount.discount) === null || _b === void 0 ? void 0 : _b.expireAt)
  const subscriptionPlan =
    subscription === null || subscription === void 0 ? void 0 : subscription.plan.name
  ...
  const trialDaysLeft = (
    ...
    ? calculateTrialDaysLeft(subscription.trialEnd)
    : 0
  return {
    isEligibleForTrial,
    annualDiscount,
