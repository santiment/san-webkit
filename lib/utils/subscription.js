import { ONE_DAY_IN_MS } from './dates.js';
import { checkIsSanApiProduct, checkIsSanbaseProduct, checkIsYearlyPlan, getPlanName, } from './plans.js';
export var Status;
(function (Status) {
...
export function getApiSubscription(subscriptions) {
    return subscriptions.find((subscription) => checkIsActiveSubscription(subscription) && checkIsSanApiProduct(subscription.plan.product));
}
...
export function normalizeAnnualDiscount(annualDiscount) {
    ...
    const expireAt = discount === null || discount === void 0 ? void 0 : discount.expireAt;
    const discountExpireAt = isEligible && expireAt;
    return {
        isEligible,
        expireAt,
        percent: isEligible && (discount === null || discount === void 0 ? void 0 : discount.percentOff),
