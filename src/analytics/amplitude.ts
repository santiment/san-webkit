...
export function initAmplitude(
  {
    id = '4acc1be0881406053d73b6e7429248d5',
    scriptSrc = 'https://cdn.amplitude.com/libs/analytics-browser-1.5.1-min.js.gz',
    serverUrl,
  } = {} as {
    id?: string
    scriptSrc?: string
  ...
  newHeadScript(`!function(){"use strict";!function(e,t){var r=e.amplitude||{_q:[],_iq:[]};if(r.invoked)e.console&&console.error&&console.error("Amplitude snippet has been loaded.");else{r.invoked=!0;var n=t.createElement("script");n.type="text/javascript"${
    scriptSrc
      ? ''
