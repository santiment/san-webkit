          ...
          {#each month.weeks as weekDates}
            <RangeCalendar.GridRow class="flex w-full">
              {#each weekDates as date}
                <RangeCalendar.Cell
                  {date}
                  class="relative m-0 size-8 !p-0 text-center text-sm focus-within:z-20"
                >
                  <RangeCalendar.Day
                    {date}
                    month={month.value}
                    class={cn(
                      'size-8 rounded hover:bg-athens hover:text-green',
                  ...
                  >
                    <div
                      class="bg-foreground absolute top-[5px] hidden size-1 rounded-full group-data-[today]:block group-data-[selected]:bg-red"
                    />
                    {date.day}
                  </RangeCalendar.Day>
                </RangeCalendar.Cell>
