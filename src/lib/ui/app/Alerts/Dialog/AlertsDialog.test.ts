...
import type { TAssetApiAlert, TAssetApiAlertPart } from '../categories/asset/schema.js'
import type { TAssetSlug } from '$lib/ctx/assets/api.js'
import type { TMetricConditionsApiAlertPart } from '../form-steps/metric-conditions/schema.js'
...
describe('AlertsDialog', async () => {
  ...
  test.only('prefilled asset alert', async () => {
    const alert: Partial<TAssetApiAlert> = {
      cooldown: '2w',
      description:
