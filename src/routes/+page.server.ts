import { BlockNoteSchema, defaultBlockSpecs, getTipTapExtensions } from '@blocknote/core'
...
export const load = async () => {
  ...
  const renderedHTML = renderToHTMLString({
    ...
    options: {
      nodeMapping: {
        alert: ({ node, parent, renderElement, children }) => {
          console.log('nodeMapping->', children)
