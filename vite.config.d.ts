...
export declare function createConfig({ corsOrigin, sveltekit, astro, bulletshell, reportMissingPreloadScripts, }?: {
    astro?: boolean;
    bulletshell?: boolean;
    corsOrigin?: string;
...
export declare function createAstroConfig(): Promise<Record<string, any>>;
