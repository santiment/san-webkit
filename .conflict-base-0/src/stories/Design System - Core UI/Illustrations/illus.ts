export const ILLUS = prepareIconsData(
  import.meta.glob('../../../lib/illus/**', { query: '?raw', eager: true, import: 'default' }),
  '../../../lib/illus/',
)

export const ILLUS_CATEGORIES = categorize(ILLUS)
console.log(ILLUS_CATEGORIES)
