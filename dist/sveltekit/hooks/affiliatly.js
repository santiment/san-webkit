...
const BOT_USER_AGENT_REGEX = /bot|crawler|spider|crawling|google|bing|yandex|yahoo|duckduckgo|telegram|twitter|facebook/i;
...
async function saveAffiliateCookie(response, cookies) {
    if (!response?.ok)
        return;
...
export const affiliatlyTrackHandle = async ({ event, resolve }) => {
...
export function createAffiliatlyConversionHandler() {
