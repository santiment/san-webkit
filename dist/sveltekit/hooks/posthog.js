...
import { POSTHOG_URL, PROXY_ROUTE } from '../../analytics/posthog/index.js';
import { logger } from '../../logger/index.js';
const ensureSlash = (route) => (route[0] === '/' ? route : `/${route}`);
export const posthogTrackHandle = async ({ event, resolve }) => {
