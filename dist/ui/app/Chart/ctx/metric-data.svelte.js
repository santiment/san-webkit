...
import { MetricStatus } from '../../../../ctx/metrics-registry/api.js';
...
import { processDataStoreScope, useMetricSeriesCtx } from './series.svelte.js';
import {} from '../api/index.js';
...
<ul class="ml-4 column">
  <li class="list-disc">Handle the division programmatically: <code>if(m2 == 0, 0, m1 / m2)</code></li>
    ...
    $effect(() => {
        ...
        const selector = ('selector' in metric && $state.snapshot(metric.selector.$)) ||
        ...
        const payload = {
            ...
            parameters,
            recache,
            dataStore: metric.type === MetricType.DATA_STORE
