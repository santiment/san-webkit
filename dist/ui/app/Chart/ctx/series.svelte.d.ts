...
import { type TChartCombinedDistributionMetric, type TChartMetric, type TChartMetricBase, type TMetricDataStore, type TMetricFormula, type TMetricSelector, type TMetricStyles, type TMetricType, type TMetricTypes } from '../../../../ctx/metrics-registry/types/index.js';
...
export type THelpers = {
    getAssetSelectorLabel: (metric: Extract<TSeries, {
        selector: any;
    }>) => string | undefined;
};
export declare function createSeries({ type, apiMetricName, label, data, selector, interval, pane, unit, style, lineStyle, color, visible, lastValueVisible, priceLineVisible, crosshairMarkerVisible, scaleId, scaleMargins, scaleInverted, scaleVisible, isSelectorLocked, isFilledGradient, transformData, baseline, meta, ...rest }: TChartMetric, helpers?: Partial<THelpers>): TSeries;
export declare const processDataStoreScope: (dataStore: TMetricDataStore) => {
    type: string;
};
export declare const useMetricSeriesCtx: ((defaultMetrics?: TChartMetric[], helpers?: Partial<THelpers>) => {
    metricSeries: {
        readonly $: TSeries[];
        readonly asScope$: {
            name: string;
    ...
    set: (defaultMetrics?: TChartMetric[], helpers?: Partial<THelpers>) => {
        metricSeries: {
            readonly $: TSeries[];
            readonly asScope$: {
                name: string;
...
declare function createAutoIntervalGetter(granularityRules: NonNullable<TChartMetric['meta']>['granularityRules']): ((from: Date, to: Date) => TInterval | undefined) | undefined;
export {};
