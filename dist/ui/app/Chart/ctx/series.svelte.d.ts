...
export declare function createSeries({ name, label, selector, scaleId, style, color, pane, visible, scaleMargins, scaleInverted, transform, transformData, tooltipFormatter, scaleFormatter, formula, meta, }: TMetric & {
