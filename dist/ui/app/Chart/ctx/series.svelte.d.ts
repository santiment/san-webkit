...
export declare function createSeries({ type, apiMetricName, label, data, selector, interval, pane, unit, style, color, visible, scaleId, scaleMargins, scaleInverted, scaleVisible, isSelectorLocked, isFilledGradient, transformData, baseline, meta, ...rest }: TChartMetric, helpers?: Partial<THelpers>): TSeries;
