...
export declare function createSeries({ type, apiMetricName, label, data, getLabels$, getSelectorLabels$, selector, interval, pane, style, color, visible, scaleId, scaleMargins, scaleInverted, scaleVisible, isSelectorLocked, isFilledGradient, transformData, tooltipFormatter, scaleFormatter, meta, ...rest }: TChartMetric): {
