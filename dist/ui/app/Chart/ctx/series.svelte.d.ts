...
export declare function createSeries({ type, apiMetricName, label, getLabels$, getSelectorLabels$, selector, interval, pane, style, color, visible, scaleId, scaleMargins, scaleInverted, scaleVisible, isSelectorLocked, transformData, tooltipFormatter, scaleFormatter, meta, ...rest }: TChartMetric): {
