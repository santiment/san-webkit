...
import { downloadBlob } from '../../../utils/download/index.js';
const LEGEND_CONFIG = {
...
function createCompositeScreenshot(container) {
...
function drawMetricsOnCanvas(ctx, chart, metrics) {
    const metricsGroupedByPane = {};
...
function prepareLegendDataForMetric(metric) {
    ...
    const percentChangeText = firstValue !== undefined && lastValue !== undefined
...
function drawLegendBadge(ctx, legendData, position) {
