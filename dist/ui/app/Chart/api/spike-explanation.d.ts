...
export declare const queryGetMetricSpikeExplanations: <GExecutor extends (<T>(schema: import("../../../../api/executor").TGqlSchema, options?: Partial<{
    ...
    explanation: string;
    spikeStartDatetime: number;
    spikeEndDatetime: number;
}[] = {
    explanation: string;
    spikeStartDatetime: number;
    spikeEndDatetime: number;
}[]>(variables: any) => GExecutor extends (...args: any[]) => import("rxjs").Observable<any> ? import("rxjs").Observable<GData> : Promise<GData>;
