...
const createDrawingTool = (apiDrawing) => ({
...
export const useDrawingToolsCtx = createCtx('webkit_useDrawingToolsCtx', ({ drawings: defaultDrawings = [], onDrawingChange, onNewDrawing, } = {}) => {
    ...
    let drawings = $state.raw(defaultDrawings.map(createDrawingTool));
    ...
    return {
        drawingTools: {
            ...
            drawings: {
                ...
                add(apiDrawing, metric, insertAtIndex) {
