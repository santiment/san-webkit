...
export declare abstract class DrawingPrimitive<GDrawingType extends string, GOptions extends object = object> implements ISeriesPrimitive<Time> {
    ...
    constructor(data: TData, options?: Partial<GOptions>);
    protected constructOptions(options: Partial<GOptions>): Partial<GOptions>;
    ...
    applyOptions(options: Partial<TOptions & GOptions>): void;
