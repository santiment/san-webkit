...
import { type TLineStyles } from '../types.js';
...
export declare function createLineSegments(lineStyle: TLineStyles, lineWidth: number, scope: BitmapCoordinatesRenderingScope): readonly [number, number] | undefined;
export declare function drawLine(ctx: CanvasRenderingContext2D, x1: number, y1: number, x2: number, y2: number, width: number, color: string, lineDash?: readonly [number, number]): void;
