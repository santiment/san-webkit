export declare const mutateUpdateSubscription: <GExecutor extends (<T>(schema: import("../../../api/executor").TGqlSchema, options?: Partial<{
    ...
    executor: GExecutor;
} & import("../../../api/index.js").TExecutorOptions)) => <GData extends unknown = unknown>(currentSubscriptionId: string | number, planId: string | number) => GExecutor extends (...args: any[]) => import("rxjs").Observable<any> ? import("rxjs").Observable<GData> : Promise<GData>;
