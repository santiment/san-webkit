...
export const usePaymentFormCtx = createCtx('usePaymentFormCtx', ({ defaultPlan = null } = {}) => {
    ...
    const resultPayment = ssd(() => {
        ...
        if (!formatted)
            return { amount: 10000000, price: 100000 };
        return {
...
export const mutateCreateStripeSetupIntent = ApiMutation(() => `mutation { createStripeSetupIntent { clientSecret } }`, (data) => data.createStripeSetupIntent.clientSecret);
