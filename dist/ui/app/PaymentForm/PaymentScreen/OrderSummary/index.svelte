...
import { useDelayFlow } from "../../../../../ctx/stripe/index.js";
...
const { paymentForm, billingPeriod, subscriptionPlan, discount, resultPayment } = usePaymentFormCtx();
...
async function onPayClick(e) {
  ...
  startCardPaymentFlow({ action }).then((data) => {
