...
const CARD_STEPS = [
  ...
  },
  {
    ...
    description: "Review your needs and adjust your plan settings by today to ensure the best fit for your requirements"
  },
  {
    icon: { id: "wallet" },
    name: getFormattedMonthDayYear(trialEndDate) + " - Your new subscription starts",
    description: "Your selected plan will activate automatically, ensuring uninterrupted service and access"
  }
];
const CRYPTO_STEPS = [
  {
  ...
  },
  {
    ...
    description: "Review your needs, adjust your plan settings. We will be happy to guide you through the payment process"
  },
  {
