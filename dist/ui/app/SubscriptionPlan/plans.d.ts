...
export declare const getSubscriptionPlanKey: (planName: string) => string;
export declare function convertSubscriptionPlan(planName: string): TPlan | null;
...
export declare function checkIsTrialEligiblePlan(planKey?: TSubscriptionPlan['name']): planKey is "PRO";
export declare function getNextUpgradePlan(plan: TPlan): TPlan | undefined;
