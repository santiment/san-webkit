...
export type TOnboardingGoal = 'BUILD_ANALYSIS' | 'CATCH_TRENDS' | 'MAKE_BETTER_TRADE_ENTRIES' | 'UNDERSTAND_WHATS_GOING_ON';
export type TOnboardingTool = 'PRICE_CHARTS' | 'SCREENERS' | 'NEWS_FEEDS' | 'ON_CHAIN_ANALYTICS' | 'SOCIAL_SIGNALS' | 'NONE_OF_THE_ABOVE';
