...
export type TBaseSchema = TStepBaseSchema<'metric-conditions', TApiAlert<TAlertSettings>, TMetricConditionsState>;
export declare const STEP_METRIC_CONDITIONS_SCHEMA: {
    readonly name: "metric-conditions";
    readonly initState: (apiAlert?: Partial<TApiAlert<TAlertSettings>> | null | undefined) => TMetricConditionsState;
    ...
    readonly reduceToApi: (state: TMetricConditionsState) => import("../../../../../utils/types/index.js").DeepPartial<TApiAlert<TAlertSettings>>;
};
export {};
