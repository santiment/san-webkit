...
export declare const SimpleOperations: {
    readonly above: {
        readonly label: "More than";
        readonly describe: ([value]: [number, number]) => string;
    } & Record<"key", "above">;
    ...
    readonly inside_channel: {
        ...
        readonly describe: ([left, right]: [number, number]) => string;
...
export declare const CombinedOperations: {
    readonly percent_up_or_down: {
