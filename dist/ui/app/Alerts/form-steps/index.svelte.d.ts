...
export type TBaseState<GStepSchema extends TStepBaseSchema<string, any> = TStepBaseSchema<string, any>> = {
...
export type TAlertStep<GStepSchema extends TStepBaseSchema<string, any> = TStepBaseSchema<string, any>> = {
