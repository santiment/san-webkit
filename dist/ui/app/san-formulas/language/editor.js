...
import { getModelMetadata, setModelMetadata } from './metadata.js';
...
export function createEditor(domElement, value) {
    ...
    return {
        api: { editor, model },
        updateMetadata: (metadata) => setModelMetadata(model, Object.assign(getModelMetadata(model) || {}, metadata)),
        dispose() {
            editor.dispose();
            model.dispose();
