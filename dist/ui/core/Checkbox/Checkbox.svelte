...
<Checkbox.Root
  ...
  bind:indeterminate
  class={cn(
    'bg-inherit flex size-4 min-w-4 items-center justify-center rounded border border-mystic fill-athens-day transition-colors',
    'group-hover/label:bg-inherit hover:border-casper hover:bg-athens group-hover/label:border-casper',
