...
export declare const queryCustomerAnnualDiscount: <GExecutor extends (<T>(schema: import("../../api/executor.js").TGqlSchema, options?: Partial<{
    ...
    executor: GExecutor;
} & import("../../api/index.js").TExecutorOptions)) => <GData extends TApiAnnualDiscount = TApiAnnualDiscount>() => GExecutor extends (...args: any[]) => import("rxjs").Observable<any> ? import("rxjs").Observable<GData> : Promise<GData>;
