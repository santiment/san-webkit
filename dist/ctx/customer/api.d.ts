...
export declare function loadCustomerData(fetcher: Parameters<typeof UniQuery>[0], update: (customerData: TCustomer | Pick<TCustomer, 'sanBalance'> | Pick<TCustomer, 'annualDiscount'>) => void): void;
export {};
