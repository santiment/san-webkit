...
export declare function createABTestCtx<T extends TBaseABSchema = TBaseABSchema>(testSchemas?: T[]): {
    ...
    useABTestCtx: ((settings: TSettingsAB<T>) => {
        ...
        maybeGet<T_1, A extends any[], R>(this: (this: T_1, ...args: A) => R, allCtxs?: Map<string, any>): R | undefined;
        get<T_1, A extends any[], R>(this: (this: T_1, ...args: A) => R, allCtxs?: Map<string, any>): R;
