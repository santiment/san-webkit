...
export declare const queryAllProjects: <GExecutor extends (<T>(schema: import("../../api/executor").TGqlSchema, options?: Partial<{
    map: (data: unknown) => T;
...
export declare const queryErc20Projects: <GExecutor extends (<T>(schema: import("../../api/executor").TGqlSchema, options?: Partial<{
    map: (data: unknown) => T;
}>) => import("rxjs").Observable<T>) | typeof import("../../api/executor").Query = <T>(schema: import("../../api/executor").TGqlSchema, options?: Partial<{
    map: (data: unknown) => T;
}>) => import("rxjs").Observable<T>>(executorConfig?: GExecutor | ({
...
export declare const queryStablecoinProjects: <GExecutor extends (<T>(schema: import("../../api/executor").TGqlSchema, options?: Partial<{
    map: (data: unknown) => T;
}>) => import("rxjs").Observable<T>) | typeof import("../../api/executor").Query = <T>(schema: import("../../api/executor").TGqlSchema, options?: Partial<{
    map: (data: unknown) => T;
}>) => import("rxjs").Observable<T>>(executorConfig?: GExecutor | ({
...
export declare const queryDeFiProjects: <GExecutor extends (<T>(schema: import("../../api/executor").TGqlSchema, options?: Partial<{
    map: (data: unknown) => T;
}>) => import("rxjs").Observable<T>) | typeof import("../../api/executor").Query = <T>(schema: import("../../api/executor").TGqlSchema, options?: Partial<{
    map: (data: unknown) => T;
}>) => import("rxjs").Observable<T>>(executorConfig?: GExecutor | ({
