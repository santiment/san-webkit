...
export declare const TOTAL_MARKET_INDEX: {
    slug: TAssetSlug;
    name: string;
    ticker: string;
    priceUsd: number;
...
export declare const FUNDS: typeof INDICES_AND_SUPPLY;
export declare function replaceFundsByAllAssetsFiltering(assets: TAsset[]): {
    slug: TAssetSlug;
    name: string;
    ticker: string;
    priceUsd: null;
