 ...
 * ```
 */
export function ApiQuery(schemaCreator, mapData, globalOptions) {
    return (executorConfig = RxQuery) => {
        ...
        return (...args) => {
            ...
            const result = executor(schema, { map: mapData, fetcher: options.fetcher });
            if (isCachingEnabled)
...
export const ApiMutation = (schemaCreator, mapData) => ApiQuery(schemaCreator, mapData, { cache: false });
