...
import { useDebouncedFn } from '../../utils/index.js';
...
export function usePosthogFlow() {
    ...
    const updateUserData = useDebouncedFn(1000, ({ id, email, name }, abTests) => id && posthog.identify(id.toString(), { user_id: id, name, email, abTests }));
    const updateUserSanbasePlan = useDebouncedFn(1000, (sanbase_plan, featureAccessLevel) => posthog.capture('$set', {
        $set: {
